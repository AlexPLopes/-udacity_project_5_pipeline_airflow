...
dag = DAG('udac_example_dag',
          ...
          description='Performs the ETL process to Redshit Airflow',
          schedule_interval='0 * * * *',
          max_active_runs=1
        )
...
stage_events_to_redshift = StageToRedshiftOperator(
    ...
    bucket_folder='udacity-dend',
    archive_diretory='log_data',
...
run_quality_checks = DataQualityOperator(
    ...
    redshift_conn_id='redshift',
    data_quality_query='select count(*) from songplays where playid is null;',
    expected_result=0,
    dag=dag
)
